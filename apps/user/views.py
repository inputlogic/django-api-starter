...
class UserList(LoggingMixin,generics.ListAPIView):
    ...
    #optional mask sensitive data. By default drf-tracking is hiding the values of those fields {'api', 'token', 'key', 'secret', 'password', 'signature'}. 
    ...
    def handle_log(self):
        ...
        if self.log['response_ms'] > 1000:
            super(UserList, self).handle_log()
    '''
